		...
		addColumn: function(bm, C, bc) {
			...
			if (bd.dataset.isModified()) {
				...
				if (U.length) {
					...
					if (bk.length) {
						if (!bd.lht) {
							bd.lc = new Ext.Template("<DIV class='grid-la' atype='grid.lc' style='width:25px;'><DIV class='grid-lh' atype='grid.lh' unselectable='on' onselectstart='return false;' style='height:25px;'><TABLE cellSpacing='0' atype='grid.lht' cellPadding='0' border='0' style='width:25px'><TBODY><TR class='grid-hl'></TR><TR height=25></TR></TBODY></TABLE></DIV><DIV class='grid-lb' atype='grid.lb' style='width:100%;height:255px'></DIV></DIV>").insertFirst(bd.wrap.dom, {},
							ag);
